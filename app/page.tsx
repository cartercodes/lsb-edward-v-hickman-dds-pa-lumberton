...
export default function HomePage() {
  ...
  const trustItems = [
    ...
    { text: 'Trusted by Patients Across Robeson County', icon: trustIcons[1] },
    { text: 'Modern Technology in a Comfortable Setting', icon: trustIcons[2] },
    { text: 'Gentle Care for Anxious Patients', icon: trustIcons[3] },
  ];
  ...
  const services = [
    ...
    { title: 'Cosmetic Dentistry', desc: 'Teeth whitening, veneers, and smile makeovers that give you the confidence to light up every room in Lumberton. Results you can see from the very first visit.', icon: serviceIcons[1] },
    { title: 'Dental Implants', desc: 'Permanent tooth replacement that looks, feels, and functions like your natural smile. Restore your confidence with implants placed right here in Lumberton.', icon: serviceIcons[2] },
    { title: 'Emergency Dental Care', desc: 'Toothaches and dental emergencies don\'t wait, and neither do we. Same-day appointments available for Lumberton families when it matters most.', icon: serviceIcons[3] },
    { title: 'Preventive Cleanings', desc: 'Routine exams, deep cleanings, and digital X-rays designed to catch problems early and keep your smile healthy for decades. Prevention is always the best investment.', icon: serviceIcons[4] },
    { title: 'Restorative Dentistry', desc: 'Crowns, bridges, and fillings crafted with precision to restore damaged teeth and get you back to living comfortably. Durable results you can count on.', icon: serviceIcons[5] },
  ];
  ...
  return (
    <>
      ...
      <nav className="nav" role="navigation" aria-label="Main navigation">
        <div className="nav-logo">{'Edward V. Hickman, DDS, PA'}</div>
        <a
          href="tel:19107388444"
          className="nav-cta"
          aria-label="Call Edward V. Hickman, DDS, PA at +1 910-738-8444"
        >
          <span
            dangerouslySetInnerHTML={{ __html: phoneIcon }}
            aria-hidden="true"
          />
          <span>{'+1 910-738-8444'}</span>
        </a>
      </nav>

      {/* HERO */}
      <section className="hero" aria-label="Welcome to Edward V. Hickman, DDS, PA">
        ...
        <div className="hero-content">
          ...
          <p>
            Welcome to {'Edward V. Hickman, DDS, PA'} — where modern dental technology meets compassionate
      ...
      <section className="about" aria-label="About our practice">
        <div className="about-grid">
          ...
          <div className="about-content" data-animate data-delay={2}>
            <h2>About {'Edward V. Hickman, DDS, PA'}</h2>
            <p>{'Edward V. Hickman, DDS, PA has been a cornerstone of dental care in Lumberton, NC for years, earning the trust of families and individuals throughout Robeson County. Dr. Hickman and his team combine advanced dental technology with a genuinely warm, patient-first approach that makes every visit comfortable. Whether you need a routine cleaning or a complete smile transformation, this is the Lumberton dental practice that treats you like a neighbor, not a number.'}</p>
      ...
      <section className="cta-section" aria-label="Contact us">
        <div className="cta-card" data-animate>
          <h2>Contact {'Edward V. Hickman, DDS, PA'}</h2>
          <p>
          ...
          <a
            ...
            aria-label="Call Edward V. Hickman, DDS, PA to schedule an appointment"
          >
            <span
              dangerouslySetInnerHTML={{ __html: phoneIcon }}
              aria-hidden="true"
      ...
      <footer className="footer" role="contentinfo">
        <div className="footer-content">
          <div className="footer-brand">
            <div className="footer-brand-name">{'Edward V. Hickman, DDS, PA'}</div>
            <p>
          ...
          <div className="footer-contact">
            <div className="footer-contact-item">
              ...
              />
              <span>
                {'720 Oakridge Blvd, Lumberton, NC 28358, USA'}, {'Lumberton'}, {'NC'}
              </span>
            </div>
            <div className="footer-contact-item">
              <span
              ...
              <a
                href="tel:19107388444"
                aria-label="Call Edward V. Hickman, DDS, PA"
        ...
        <div className="footer-bottom">
          &copy; {new Date().getFullYear()} {'Edward V. Hickman, DDS, PA'}. All rights
          reserved.
        </div>
      </footer>
    </>
